                                        ...
                                        <?php foreach ($taisans as $taisan): ?>
                                            <?php if ($taisan->id == $suachua->taisan_id): ?>
                                                <select name="taisansuachua" class="form-control">  
                                                    <option value="{{$taisan->id}}">{{$taisan->tentaisan}} |SL hư hỏng: {{$suachua->soluong}}</option>
                                                </select>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="tinhtrang" class="form-control">  
                                            <?php if ($suachua->tinhtrang==1): ?>
                                                <option value="{{$suachua->tinhtrang}}">Bình Thường</option>
                                            <?php elseif($suachua->tinhtrang==2): ?>
                                                <option value="{{$suachua->tinhtrang}}">Hư Hỏng</option>
                                            <?php elseif($suachua->tinhtrang==3): ?>
                                                <option value="{{$suachua->tinhtrang}}">Mất Tài Sản</option>
                                            <?php endif; ?>    
                                        </select>
                                    </div>
                                </div>
