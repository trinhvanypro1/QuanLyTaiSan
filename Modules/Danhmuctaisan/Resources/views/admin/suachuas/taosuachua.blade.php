...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.danhmuctaisan.suachua.index') }}">{{ trans('Sửa Chữa Tài Sản') }}</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                            ...
                            <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                                @include('danhmuctaisan::admin.suachuas.partials.taosuachua-fields', ['lang' => $locale])
                            </div>
                        @endforeach

                        <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat">{{ trans('Sửa Chữa') }}</button>
